...
Forge 1.16.5, 1.18.2, 1.19.2, and 1.20.1 use
...
1.18.2 keeps its own rendered-text and client bootstrap because it still uses
`TextComponent` / `TranslatableComponent` and unsigned `LocalPlayer.chat`.
