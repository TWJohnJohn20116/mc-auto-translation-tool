...
abstract class UniversalTranslatorConfigScreenBase extends Screen {
    ...
    protected final void init() {
        ...
        blockedKeywords = addRenderableWidget(new EditBox(font, layout.right, layout.row(5),
                layout.buttonWidth, 20, new TranslatableComponent("screen.universal_translator.blocked_keywords")));
    ...
    private Button button(int x, int y, int width, Runnable action) {
        return new Button(x, y, width, 20, new TextComponent(""), button -> {
            action.run();
            refreshLabels();
        });
    }
    ...
    private void refreshLabels() {
        ...
        mixedTextButton.setMessage(new TranslatableComponent("screen.universal_translator.option.mixed",
                onOff(translateEnglishOnly)));
        colorButton.setMessage(new TranslatableComponent("screen.universal_translator.option.color",
                colorLabel(translatedTextColor)));
        downloadButton.setMessage(isLlm()
                ? new TranslatableComponent("screen.universal_translator.option.llm_settings")
                : new TranslatableComponent("screen.universal_translator.option.download", onOff(offlineAutoDownload)));
        ...
        playerNamesButton.setMessage(new TranslatableComponent("screen.universal_translator.option.player_names",
        ...
        outgoingButton.setMessage(new TranslatableComponent("screen.universal_translator.option.outgoing",
