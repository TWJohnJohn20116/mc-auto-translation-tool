...
final class UniversalTranslatorConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.translationTabButton = addDrawableChild(ButtonWidget.builder(
                Text.translatable("screen.universal_translator.tab.translation"),
        ...
        this.serviceTabButton = addDrawableChild(ButtonWidget.builder(
                Text.translatable("screen.universal_translator.tab.service"),
        ...
        this.advancedTabButton = addDrawableChild(ButtonWidget.builder(
                Text.translatable("screen.universal_translator.tab.advanced"),
        ...
        addDrawableChild(ButtonWidget.builder(
                Text.translatable("screen.universal_translator.save"), button -> saveAndApply())
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer,
                Text.translatable(page.descriptionKey),
        ...
        if (!status.isEmpty()) {
            ...
            drawCenteredText(matrices, this.textRenderer,
                    Text.translatable(isOffline() ? "screen.universal_translator.info.offline" : "screen.universal_translator.info.api"),
