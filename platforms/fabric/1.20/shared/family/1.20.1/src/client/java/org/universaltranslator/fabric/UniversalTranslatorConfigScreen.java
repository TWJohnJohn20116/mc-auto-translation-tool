...
final class UniversalTranslatorConfigScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (animatedUi) {
            ...
            context.fill(tabX, layout.tabY() + 20, tabX + layout.tabWidth(), layout.tabY() + 22, 0xFF55D6FF);
        }
        context.drawCenteredTextWithShadow(this.textRenderer, this.title, this.width / 2, 16,
