...
final class UniversalTranslatorConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.diagnosticsButton = addDrawableChild(ButtonWidget.builder(
            ...
            if (this.minecraft != null) {
                this.minecraft.openScreen(new UniversalTranslatorDiagnosticsScreen(this));
            }
        ...
        this.endpoint = addDrawableChild(new TextFieldWidget(
                this.font, left, layout.contentRow(1), layout.totalWidth, 20,
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        if (animatedUi) {
            ...
            fill(tabX, layout.tabY() + 20, tabX + layout.tabWidth(), layout.tabY() + 22, 0xFF55D6FF);
        }
        drawCenteredString(this.font, this.title.getString(), this.width / 2, 16,
        ...
        if (!status.isEmpty()) {
            ...
            if (activeTab == Tab.OUTGOING) {
                drawCenteredString(this.font,
                        new TranslatableText("screen.universal_translator.info.outgoing_hint").getString(),
                        this.width / 2, layout.contentRow(2) + 6, 0xFFA0A0A0);
            } else if (activeTab == Tab.GENERAL) {
                drawCenteredString(this.font,
                        new TranslatableText("screen.universal_translator.info.keybind").getString(),
