...
Tencent Hunyuan credentials and other advanced provider keys can still be edited in
`config/universal-translator.properties` if the in-game editor does not expose them.
