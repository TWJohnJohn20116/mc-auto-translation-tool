...
Fabric 1.16.5 completed its Java 8, merged-JAR, legacy text/UI/chat API migration, plus a clean build,
remapping, and shared-core self-test. Fabric 26.1 completed a clean build, Mixin injection checks, and an actual launch to the main menu.
