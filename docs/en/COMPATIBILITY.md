...
Fabric 1.19.2 completed its MatrixStack, legacy-button, chat-signature, and rendering-method migration,
plus a clean build, remapping, and shared-core self-test. Fabric 26.1 completed a clean build, Mixin injection checks, and an actual launch to the main menu.
