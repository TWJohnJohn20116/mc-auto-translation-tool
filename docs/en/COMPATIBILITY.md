...
Fabric 1.21.4 completed its Yarn method-signature migration, a clean build, remapping, and the
shared-core self-test. Fabric 26.1 completed a clean build, Mixin injection checks, and an actual launch to the main menu.
