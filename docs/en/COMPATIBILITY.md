...
All 33 exact build artifacts share the same translation core and are reduced to 14 directly installable release JARs. Fabric 1.20.1 completed Loom remapping.
