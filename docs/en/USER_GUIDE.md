...
Version 1.3.9 includes adapters for Baidu, Tencent Cloud TMT, Alibaba Cloud MT, Youdao,
...
This guide covers the `1.3.9` release. Thirty release build targets are packaged into 15
