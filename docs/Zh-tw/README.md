...
| 26.1、26.1.1、26.1.2、26.2（精確版本 JAR） | Forge | 25 |
| 1.21–1.21.11（單一 JAR） | Fabric | 21 |
| 1.21、1.21.1、1.21.3–1.21.11（精確版本 JAR） | Forge | 21 |
| 1.20.1 | Forge | 17 |
| 1.20.1 | Fabric | 17 |
| 1.19.2（開發中） | Forge | 17 |
...
主分支另包含 Fabric 1.16.5、Fabric 1.19.2、Forge 1.16.5 與 Forge 1.19.2 獨立開發轉接；完成實機及伺服器內人工
迴歸前不提供正式版下載。
